...
(while (re-search-forward "\\[\\[file:~/octopress/source" nil t)
  (replace-match "[[http://mutbuerger.github.io/images/")
)
#+END_SRC
...
#+RESULTS:
[[http://mutbuerger.github.io/images//images/1.png]]
...
#+RESULTS:
[[http://mutbuerger.github.io/images//images/2.png]]
...
#+RESULTS:
[[http://mutbuerger.github.io/images//images/3.png]]
...
#+RESULTS:
[[http://mutbuerger.github.io/images//images/4.png]]
