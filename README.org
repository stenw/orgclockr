...
#+BEGIN_SRC R :results graphics :file "~/R-programming/images/a.png" :ravel message=FALSE, warning=FALSE, fig.width=7, fig.height=5, fig.cap='The time spent per day for the last 3 months'
library(zoo)
...
#+BEGIN_SRC R :results graphics :file "~/R-programming/images/b.png" :ravel message=FALSE, warning=FALSE, fig.cap='A very simple retrospective Gantt chart diagram'
org_clock_df(orgfile) %>%
...
#+BEGIN_SRC R :results graphics :file "~/R-programming/images/c.png" :ravel message=FALSE, warning=FALSE, fig.cap='Plotting the time spent total per task'
...
#+BEGIN_SRC R :results graphics :file "~/R-programming/images/d.png" :ravel message=FALSE, warning=FALSE, fig.cap='Compare the time spent per task to the effort set'
library(tidyr)
