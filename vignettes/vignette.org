...
#+BEGIN_SRC R :results graphics :file "~/R-programming/orgclockr/images/orgclockr1.png" :ravel message=FALSE, warning=FALSE, fig.width=7, fig.height=5, fig.cap='The time spent per day for the last 3 months'
library(zoo)
...
#+RESULTS:
[[file:~/R-programming/orgclockr/images/orgclockr1.png]]
...
#+BEGIN_SRC R :results graphics :file "~/R-programming/orgclockr/images/orgclockr2.png" :ravel message=FALSE, warning=FALSE, fig.cap='A very simple retrospective Gantt chart diagram'
org_clock_df(orgfile) %>%
...
#+RESULTS:
[[file:~/R-programming/orgclockr/images/orgclockr2.png]]

This plot is pretty much self-explanatory:

#+BEGIN_SRC R :results graphics :file "~/R-programming/orgclockr/images/orgclockr3.png" :ravel message=FALSE, warning=FALSE, fig.cap='Plotting the time spent total per task'
...
#+RESULTS:
[[file:~/R-programming/orgclockr/images/orgclockr3.png]]
...
#+BEGIN_SRC R :results graphics :file "~/R-programming/orgclockr/images/orgclockr4.png" :ravel message=FALSE, warning=FALSE, fig.cap='Compare the time spent per task to the effort set'
library(tidyr)
...
#+RESULTS:
[[file:~/R-programming/orgclockr/images/orgclockr4.png]]
